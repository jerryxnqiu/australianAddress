...
# Setup Google Cloud Storage Access
path_to_private_key = './datacollection-379709-a63303193253.json'
client = storage.Client.from_service_account_json(json_credentials_path=path_to_private_key)

# The bucket on GCS in which to write the CSV file
export_bucket = client.bucket('g_naf_202211')

# Process the dataframe
folderPath = r"gs://g_naf_202211/"
...
blob = export_bucket.blob('00output_{}.csv'.format(datetime.today().strftime('%Y-%m-%d')))
blob.upload_from_string(ADDRESS_DETAIL_psv_full.to_csv(), 'text/csv')